            ...
            <div>
                ...
                >
                  ...
                  <div className=''>
                    ...
                    <div className='text-[10px]'><span className="font-bold mr-[5px]">Language:</span> {selectedBook.volumeInfo.language}</div>
                    <div className='text-[10px]'><span className="font-bold mr-[5px]">Rating:</span>{selectedBook.volumeInfo.maturityRating === "NOT_MATURE"
